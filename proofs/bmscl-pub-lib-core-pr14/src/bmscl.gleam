...
/// Adapt the stable BeamScale platform Context into an application-owned
/// context before invoking user code.
///
/// This keeps the runtime ABI small while allowing applications to attach
/// database handles, caches, repositories, request-scoped services, or other
/// dependency-injection state through their own context type.
...
/// policy or capability declarations.
