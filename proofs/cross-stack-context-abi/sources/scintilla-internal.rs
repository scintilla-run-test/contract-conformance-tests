...
pub const CONTEXT_ABI_V1: &str = "scintilla.run/context/v1";
...
mod tests {
    ...
    #[test]
    fn context_abi_matches_public_lambda_sdk_identity() {
        assert_eq!(CONTEXT_ABI_V1, "scintilla.run/context/v1");
    }
